...
<body>
    ...
    <div class="tab2">
      <a href="viewBookings.php"><button  style=" background-color:#737373; color: white;" class=activeBut>Client confirmed</button></a>  
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>CONFIRMED BOOKINGS</b></h2>
            </center>

            <fieldset>
                <legend align=center>This is all the booking that clients have confirmed</legend>
 ...
 $getMe="SELECT `paymentId`,  `state`,  `datAdded`, `prize`,`Process` FROM `payment` WHERE `state` ='Confirmed'";
