...
<body>
    ...
    <div class="tab2">
      <a href=ManageBookings.php><button >Accept order</button></a>  
        <a href=ConfirmPayment.php><button style=" background-color:#737373; color: white;" class=activeBut >Confirm Payment</button></a>
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>PAYMENT CONFOORMATION</b></h2>
            </center>
  <?php
  include("config.php");
   session_start();
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql="UPDATE `payment` SET `PaymentStatus`='Payed' WHERE `paymentId`='$num'";
...
?>
            <fieldset>
                <legend align=center>Enter the order number to confirm payment</legend>
                    ...
                    <form class="form-signin" method="POST">
                       <p>Order number<sup>*</sup></p>
                        ...
                        <div class="row">
                            ...
                            <div class="column2">
                                <center> <input type="submit" value="Confirm payment" id=view name=view>
                                </center>
                            </div></div>
