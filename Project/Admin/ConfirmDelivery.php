...
<body>
    ...
    <div class="tab2">
      <a href=ManageBookings.php><button >Accept order</button></a>  
       ...
       <a href="DeclineOrder.php"><button  >Decline order</button></a> 
         <a href="ConfirmDelivery.php"><button style=" background-color:#737373; color: white;" class=activeBut>Confirm delivery</button></a>
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>CONFIRM DELIVERY</b></h2>
            </center>
  <?php
  include("config.php");
   session_start();
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql="UPDATE `payment` SET `Process`='Delivered' WHERE `paymentId`='$num'";
...
?>
            <fieldset>
                <legend align=center>Enter the order number to confirm the delivery</legend>
                    ...
                    <form class="form-signin" method="POST">
                       <p>Order number<sup>*</sup></p>
                        ...
                        <div class="row">
                            ...
                            <div class="column2">
                                <center> <input type="submit" value="Confirm order" id=view name=view>
                                </center>
                            </div></div>
