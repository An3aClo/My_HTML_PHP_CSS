...
<body>
    ...
    <a href="AdminDeclienedBookings.php"> <button  >Admin declined</button></a>   
        <a href=PayedBookings.php style=" background-color:#737373; color: white;" class=activeBut><button>Payed</button></a>
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>PAYED BOOKINGS</b></h2>
            </center>

            <fieldset>
                <legend align=center>This is all the bookings that have been payed for</legend>
                ...
                <div class="MyText">
                    ...
                    $getMe="SELECT `paymentId`,  `state`,  `datAdded`, `prize`,`Process`FROM `payment` WHERE `PaymentStatus`='Payed'";
