...
<body>
    ...
    <div class="tab2">
      <a href=ManageBookings.php><button >Accept order</button></a>  
       ...
       <a href="DeclineOrder.php"><button style=" background-color:#737373; color: white;" class=activeBut >Decline order</button></a> 
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>DECLINE ORDER</b></h2>
            </center>
  <?php
  include("config.php");
   session_start();
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql="UPDATE `payment` SET `Process`='Order Declined' WHERE `paymentId`='$num'";
...
?>
            <fieldset>
                <legend align=center>Enter the order number to decline the order</legend>
                    ...
                    <form class="form-signin" method="POST">
                       <p>Order number<sup>*</sup></p>
                        ...
                        <div class="row">
                            ...
                            <div class="column2">
                                <center> <input type="submit" value="Decline order" id=view name=view>
                                </center>
                            </div></div>
