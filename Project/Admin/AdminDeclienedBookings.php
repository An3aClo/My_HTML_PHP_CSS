...
<body>
    ...
    <a href="AdminDeclienedBookings.php"> <button  style=" background-color:#737373; color: white;" class=activeBut>Admin declined</button></a>   
    ...
    <div class=m>
        <div class="myPadding">
            <center>
                <h2 class=title><b>DECLINED BOOKINGS</b></h2>
            </center>

            <fieldset>
                <legend align=center>This is all the bookings that have been declined by an admin member</legend>
                ...
                <div class="MyText">
                    ...
                    $getMe="SELECT `paymentId`,  `state`,  `datAdded`, `prize`,`Process` FROM `payment` WHERE `Process`='Order Declined'";
