...
<body>
    ...
    <div class="tab2">
      <a href="viewBookings.php"><button  >Client confirmed</button></a>  
        <a href=CCanceledBookigs.php><button style=" background-color:#737373; color: white;" class=activeBut>Client canceled</button></a>
    ...
    <div class=m>
        <div class="myPadding">
            ...
            <fieldset>
                <legend align=center>This is all the bookings that clients have canceled</legend>
 ...
 $getMe="SELECT `paymentId`,  `state`,  `datAdded`, `prize` FROM `payment` WHERE `state` ='Cancled by user'";
