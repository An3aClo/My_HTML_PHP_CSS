...
echo "<script type='text/javascript'>alert('$message');</script>";
           //header('Location:thaksMember.html'); 
        }else{
...
?>
    ...
    <div class="tab">
        ...
        <a href=ContactUsMemeber.php; style=" background-color: #152b37; color: white;"> <button>Contact Us</button></a>

        <a href=logout.php> <button id=logout onclick="mytest()">Log Out</button></a>
    </div>

    <div class="tab2">
        <button style=" background-color:#737373; color: white;" class=activeBut>User Manual</button>
    </div>
